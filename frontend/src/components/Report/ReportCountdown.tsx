...
const ReportCountdown = () => {
  return (
    <div className="bg-gradient-to-br from-main-dark10 to-main-dark40 rounded-lg p-4 hidden">
...
const CountdownItem = ({ unit, text }: { unit: Units; text: string }) => {
  ...
  return (
    <div className="flex h-16 w-1/4 flex-col items-center justify-center gap-1 border-r-[1px] border-slate-200 font-mono md:h-36 md:gap-2">
