...
interface StoreState {
  ...
  networkId: NetworkId;
  setNetworkId: (networkId: "mainnet") => void;
...
export const useWallet = createStore<StoreState>((set) => ({
  ...
  setNetworkId: (networkId: "mainnet") => set({ networkId }),
...
const getNearContract = (networkId: "mainnet") => GUESTBOOK_CONTRACT[networkId];
...
export default function NearProvider({ children }: NearProviderProps) {
  ...
  useEffect(() => {
    const wallet = new Wallet({
      createAccessKeyFor: getNearContract(networkId as "mainnet"),
